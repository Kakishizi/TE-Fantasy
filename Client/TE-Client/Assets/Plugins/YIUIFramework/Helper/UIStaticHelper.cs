...
namespace YIUIFramework
{
    ...
    public static class UIStaticHelper
    {
        ...
        public const string UINamespace = "UI"; //所有生成文件的命名空间
        ...
        public const string UIProjectResPath = "Assets/AssetRaw/" + UIProjectName; //玩家的预设/图片等资源存放的地方

        [LabelText("YIUI项目脚本路径")]
        public const string UIGenerationPath = "Assets/GameScripts/HotFix/GameLogic/UIGenaration"; //自动生成的代码

        [LabelText("YIUI项目自定义脚本路径")]
        public const string UICodeScriptsPath = "Assets/GameScripts/HotFix/GameLogic/" + UIProjectName; //玩家可编写的核心代码部分
