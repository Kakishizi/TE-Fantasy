...
{
    const string k_SettingsPathHeader = "Assets/Core/TEngine/ResRaw/Resources/";
    const string k_SettingsPath = "Assets/Core/TEngine/ResRaw/Resources/TEngineGlobalSettings.asset";
